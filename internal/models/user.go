...
const (
	ApiTokenScopeHistoryRead ApiTokenScope = "history:read"
	ApiTokenScopeSensorRead  ApiTokenScope = "sensor:read"
	ApiTokenScopeSensorWrite ApiTokenScope = "sensor:write"
